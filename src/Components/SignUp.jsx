...
function SignUp() {
  ...
  return (
    ...
    >
      ...
      <form>
        <div
          className={`bg-white font-poppins text-center border-2 border-black px-16 py-20 rounded-3xl ${
        ...
        >
          ...
          <img
            src="https://i.pinimg.com/originals/5c/ae/c6/5caec6f372267b0d147ff14ca8b97a39.jpg"
            className="w-20 mx-auto"
          />
          <label className="pl-2 flex text-center">First Name</label>
          <input
            className="indent-3 border-solid border-2 border-black rounded-xl"
            type="text"
          />
